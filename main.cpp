...
struct unittest_t {
  ...
  { "if 1 + 2 * 3 ^ 4 == 5 then $a = 6; end", { { "[1]$a = 6", 139 } }, { { "", 139 } }, 0 },
  { "if 1 + 2 * 3 ^ 4 ^ 5 == 5 then $a = 6; end", { { "[1]$a = 6", 143 } }, { { "", 143 } }, 0 },
  ...
  { "if $a == $b then $a = $c / $a + 2 * $c; end", { { "[1]$a = 9", 185 } }, { { "", 185 } }, 0 },
  { "if $a == $b then $a = $c / $a + 2 * $c * $a; end", { { "[1]$a = 9", 193 } }, { { "", 193 } }, 0 },
  { "if $a == $b then $a = $c / $a + 2 ^ $c * $a; end", { { "[1]$a = 11", 193 } }, { { "", 193 } }, 0 },
  { "if $a == $b then $a = 1 + 2 * $b / $c ^ $b ^ $a * $c ^ 2; end", { { "[1]$a = 5", 209 } }, { { "", 209 } }, 0 },
  { "if $a == $b then $a = $a + 2 * $b / $c ^ $b ^ $a * $c ^ 2; end", { { "[1]$a = 5", 209 } }, { { "", 209 } }, 0 },
