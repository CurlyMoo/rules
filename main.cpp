...
struct unittest_t {
  ...
  { "if 2.1 >= 1 then $a = 6; end", { { "$a = 6", 100 } }, { { "$a = 6", 100 } } },
  { "if 9 <= -5 then $a = 6; end", { { "$a = 6", 100 } }, { { "", 92 } } },
  ...
  { "if max(1, 12000) == max(1, 3) then $a = 1; end", { "$a = 1", 148 }, { "", 140 } },
  { "if max(1, 12222.5555) == max(1, 3) then $a = 1; end", { "$a = 1", 148 }, { "", 140 } },
  ...
  { "if 1 == 1 then $a = round(3.5); end  ", { { "$a = 3", 112 } },  { { "$a = 3", 112 } } },
  { "if 1 == 1 then $a = round(5); end  ", { { "$a = 5", 112 } },  { { "$a = 5", 112 } } },
  { "if 1 == 1 then $a = round(-5); end  ", { { "$a = -5", 112 } },  { { "$a = -5", 112 } } },
  { "if 1 == 1 then $a = round(-3.5); end  ", { { "$a = -3", 112 } },  { { "$a = -3", 112 } } },
  { "if 1 == 1 then $a = ceil(3.5); end  ", { { "$a = 4", 112 } },  { { "$a = 4", 112 } } },
  { "if 1 == 1 then $a = ceil(5); end  ", { { "$a = 5", 112 } },  { { "$a = 5", 112 } } },
  { "if 1 == 1 then $a = ceil(-5); end  ", { { "$a = -5", 112 } },  { { "$a = -5", 112 } } },
  { "if 1 == 1 then $a = ceil(-3.5); end  ", { { "$a = -3", 112 } },  { { "$a = -3", 112 } } },
  { "if 1 == 1 then $a = floor(3.5); end  ", { { "$a = 3", 112 } },  { { "$a = 3", 112 } } },
  { "if 1 == 1 then $a = floor(5); end  ", { { "$a = 5", 112 } },  { { "$a = 5", 112 } } },
  { "if 1 == 1 then $a = floor(-5); end  ", { { "$a = -5", 112 } },  { { "$a = -5", 112 } } },
  { "if 1 == 1 then $a = floor(-3.5); end  ", { { "$a = -4", 112 } },  { { "$a = -4", 112 } } },
  ...
  { "on foo then if 3 == 3 then $a = 6; elseif 3 == 3 then $b = 1; end end on bar then if 3 == 3 then $b = 3; end end", { { "$a = 6$b = 1", 228 }, { "$b = 3", 128 } },  { { "$a = 6", 220 }, { "$b = 3" , 128 } } },
